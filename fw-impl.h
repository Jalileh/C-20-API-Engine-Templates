...
class cma::systems::Rat {
 ...
 private:
   ...
   singleton_member CachedData< SubModuleInfo > cheat_info;
 ...
 public:
   ...
   u64 GetModuleByName (astr Name) {
      ...
      SubModuleInfo aptr_ CachedSubModule = cheat_info.getbyID(Name, &SubModuleInfo::ModuleName);
      ...
      if (CachedSubModule == nullptr) {
         ...
         if (requested_module > null) {
            ...
            cheat_info.AddItem({requested_module, Name.c_str()});
